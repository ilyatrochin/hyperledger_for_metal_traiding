...
function createOrg3 {
  ...
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.service.ru/peers/peer0.org3.service.ru/msp" --tls.certfiles "${PWD}/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.service.ru/peers/peer0.org3.service.ru/tls" --enrollment.profile tls --csr.hosts peer0.org3.service.ru --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  mkdir "${PWD}/../organizations/peerOrganizations/org3.service.ru/msp/tlscacerts"
  cp "${PWD}/../organizations/peerOrganizations/org3.service.ru/peers/peer0.org3.service.ru/tls/tlscacerts/"* "${PWD}/../organizations/peerOrganizations/org3.service.ru/msp/tlscacerts/ca.crt"

  mkdir "${PWD}/../organizations/peerOrganizations/org3.service.ru/tlsca"
  cp "${PWD}/../organizations/peerOrganizations/org3.service.ru/peers/peer0.org3.service.ru/tls/tlscacerts/"* "${PWD}/../organizations/peerOrganizations/org3.service.ru/tlsca/tlsca.org3.service.ru-cert.pem"

  mkdir "${PWD}/../organizations/peerOrganizations/org3.service.ru/ca"
  cp "${PWD}/../organizations/peerOrganizations/org3.service.ru/peers/peer0.org3.service.ru/msp/cacerts/"* "${PWD}/../organizations/peerOrganizations/org3.service.ru/ca/ca.org3.service.ru-cert.pem"

  infoln "Generating the user msp"
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.service.ru/users/User1@org3.service.ru/msp" --tls.certfiles "${PWD}/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://org3admin:org3adminpw@localhost:11054 --caname ca-org3 -M "${PWD}/../organizations/peerOrganizations/org3.service.ru/users/Admin@org3.service.ru/msp" --tls.certfiles "${PWD}/fabric-ca/org3/tls-cert.pem"
  { set +x; } 2>/dev/null
